...
import edu.inpt.ouroborous.DBSingletonConnection;
...
public class ProductManagerServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (!loggedInUser.equals("admin")) {
			response.sendError(HttpServletResponse.SC_FORBIDDEN, "You're not authorized to add products.");
			System.out.println("Error! request to add product from non admin");
			return;
		}
		...
		switch (pathInfo) {
			case "/ouROBOrous/add_product":
				addProduct(request, response);
				break;
			case "/ouROBOrous/remove_product":
