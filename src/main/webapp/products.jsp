...
<%@ page import="edu.inpt.ouroborous.ProductDAOImpl"%>
...
<body class="">
	...
	<div class="container mt-2 mb-4">
		<div class="card">
			...
			<div
				...
				<a class="btn btn-primary" href="/ouROBOrous/add_product.jsp">Add
					New Product</a>
			</div>
			<div class="card-body">
				<%
				...
				<table class="table align-middle table-stripped">
					...
					<tbody>
						...
						<tr id="productRow_<%=product.getProductId()%>">
							...
							<td>
								<div>
									<a type="button" class="btn btn-secondary ml-1">Edit</a>
									<button type="button" class="btn btn-danger"
										onclick="removeProduct(<%=product.getProductId()%>);">Remove</button>
								</div>
							</td>
						</tr>
				...
				<div class="col d-flex justify-content-center mt-1 mb-1">
					<div class="card specific-w-300">
						...
						<div class="card-body">
							...
							<a href="/ouROBOrous/cart_action?add=<%=product.getProductId()%>"
								class="stretched-link btn btn-success btn-lg w-100"> <i
								class="fa-solid fa-bag-shopping me-1"></i> Add to bag
							</a>
						</div>
					</div>
				</div>
    ...
    function doRemoveRequest() {
		modal.hide();
        $.post(`/ouROBOrous/remove_product`, {product_id: productIdTarget})
        .done(function() {
